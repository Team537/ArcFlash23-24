...
//    public static int wait6 = 500;
    ...
    public  double claw1TargetPosition = 0;
    ...
    public static double clawOpenPosition1 = 0;
    public static double clawClosedPosition1 = 0.75;

    public static double clawOpenPosition2 = 0;
    public static double clawClosedPosition2 = 0.75;

    public static double wristDownPosition = 1;
